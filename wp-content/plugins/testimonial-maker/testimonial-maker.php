...
if ( ! class_exists( 'awl_testimonial' ) ) {
	class awl_testimonial {		
		...
		protected function _constants() {
			...
			//Plugin Slug
			define( 'TML_PLUGIN_SLUG', 'testimonial' );
		...
		public function tmonial_menu() {
			...
			$buy_plugin_page = add_submenu_page( 'edit.php?post_type='.TML_PLUGIN_SLUG, __( 'Upgrade Plugin', TML_TXTDM ), __( 'Upgrade Plugin', TML_TXTDM ), 'administrator', 'buy-tml-page', array( $this, 'buy_tml_page') );
			$theme_menu    = add_submenu_page( 'edit.php?post_type='.TML_PLUGIN_SLUG, __( 'Our Theme', TML_TXTDM ), __( 'Our Theme', TML_TXTDM ), 'administrator', 'sr-theme-page', array( $this, 'tm_theme_page') );
		...
		public function Testimonial() {
		 ...
		 public function admin_add_meta_box() {
			add_meta_box( '', __('Add Client detail', TML_TXTDM), array(&$this, 'tml_testimonial_upload'), 'testimonial', 'normal', 'default' );
		} 
		...
		public function tmonial_setting_page() {
			require_once('testimonial-setting.php');
		} 
		public function tmonial_featured_page() {
			require_once('featured-plugins/featured-plugins.php');
		} 
		public function buy_tml_page() {
			require_once('buy-tml-premium.php');
		}
		
		// theme page
		public function tm_theme_page() {
